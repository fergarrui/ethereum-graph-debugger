...
export const FETCH_TRANSACTION_DEBUGGER = 'FETCH_TRANSACTION_DEBUGGER';
export const FETCH_STORAGE = 'FETCH_STORAGE';
export const FETCH_GRAPH = 'FETCH_GRAPH';
export const FETCH_DISASSEMBLER = 'FETCH_DISASSEMBLER'; 
export const FETCH_ANALYZER = 'FETCH_ANALYZER';
export const FETCH_FILE_ANALYZER = 'FETCH_FILE_ANALYZER';
export const DEBUGGER_FETCH_SUCCESS = 'DEBUGGER_FETCH_SUCCESS';
export const STORAGE_FETCH_SUCCESS = 'STORAGE_FETCH_SUCCESS';
export const GRAPH_FETCH_SUCCESS = 'GRAPH_FETCH_SUCCESS';
export const DISASSEMBLER_FETCH_SUCCESS = 'DISASSEMBLER_FETCH_SUCCESS';
export const ANALYZER_FETCH_SUCCESS = 'ANALYZER_FETCH_SUCCESS';
export const FILE_ANALYZER_FETCH_SUCCESS = 'FILE_ANALYZER_FETCH_SUCCESS';
